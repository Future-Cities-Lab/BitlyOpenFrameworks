...
private:
        ...
        void drawLeadingEdge(int s, int e, float noise[], int hr, float len, ofMesh *mesh);
        void drawAlphaGradient(int start, float alpha, ofMesh *mesh);
        void drawRegions(int rS[24][5], int rL[24][5], ofMesh *mesh) ;
        void gradiateRegions(int data[24][5][2], int nD[24][5][2], int (*rS)[5], int (*rL)[5], float c);
        void updateNoiseValues();
        void updateGlobalCounter();
        void updateRegions(const int data[24][5][2], int (*rs)[5], int (*rl)[5]);
        ...
        float nLMap(float i, float iMi, float iMa, float oMi, float oma, float s);
